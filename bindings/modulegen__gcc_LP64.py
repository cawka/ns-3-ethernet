...
def module_init():
    root_module = Module('ns.ethernet', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    module.add_class('Backoff', import_from_module='ns.csma')
    ...
    ## ethernet-net-device.h (module 'ethernet'): ns3::ProxyTracedCallback [class]
    module.add_class('ProxyTracedCallback')
    ...
    ## ethernet-helper.h (module 'ethernet'): ns3::EthernetHelper [class]
    module.add_class('EthernetHelper', parent=[root_module['ns3::PcapHelperForDevice'], root_module['ns3::AsciiTraceHelperForDevice']])
    ...
    ## ethernet-channel.h (module 'ethernet'): ns3::EthernetChannel [class]
    module.add_class('EthernetChannel', parent=root_module['ns3::Channel'])
    ...
    module.add_class('CsmaNetDevice', import_from_module='ns.csma', parent=root_module['ns3::NetDevice'])
    ## csma-net-device.h (module 'csma'): ns3::CsmaNetDevice::EncapsulationMode [enumeration]
    module.add_enum('EncapsulationMode', ['ILLEGAL', 'DIX', 'LLC'], outer_class=root_module['ns3::CsmaNetDevice'], import_from_module='ns.csma')
    ## ethernet-net-device.h (module 'ethernet'): ns3::EthernetNetDevice [class]
    module.add_class('EthernetNetDevice', parent=root_module['ns3::NetDevice'])
...
def register_methods(root_module):
    ...
    register_Ns3ProxyTracedCallback_methods(root_module, root_module['ns3::ProxyTracedCallback'])
    ...
    register_Ns3EthernetHelper_methods(root_module, root_module['ns3::EthernetHelper'])
    ...
    register_Ns3EthernetChannel_methods(root_module, root_module['ns3::EthernetChannel'])
    ...
    register_Ns3EthernetNetDevice_methods(root_module, root_module['ns3::EthernetNetDevice'])
    return
...
def register_Ns3ProxyTracedCallback_methods(root_module, cls):
    ## ethernet-net-device.h (module 'ethernet'): ns3::ProxyTracedCallback::ProxyTracedCallback(ns3::ProxyTracedCallback const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ProxyTracedCallback const &', 'arg0')])
    ## ethernet-net-device.h (module 'ethernet'): ns3::ProxyTracedCallback::ProxyTracedCallback(std::string const & name, ns3::Ptr<ns3::Object> obj1, ns3::Ptr<ns3::Object> obj2=0) [constructor]
    cls.add_constructor([param('std::string const &', 'name'), param('ns3::Ptr< ns3::Object >', 'obj1'), param('ns3::Ptr< ns3::Object >', 'obj2', default_value='0')])
    ## ethernet-net-device.h (module 'ethernet'): void ns3::ProxyTracedCallback::Connect(ns3::CallbackBase const & callback, std::string context) [member function]
    cls.add_method('Connect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'callback'), param('std::string', 'context')])
    ## ethernet-net-device.h (module 'ethernet'): void ns3::ProxyTracedCallback::ConnectWithoutContext(ns3::CallbackBase const & callback) [member function]
    cls.add_method('ConnectWithoutContext', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'callback')])
    ## ethernet-net-device.h (module 'ethernet'): void ns3::ProxyTracedCallback::Disconnect(ns3::CallbackBase const & callback, std::string context) [member function]
    cls.add_method('Disconnect', 
                   'void', 
                   [param('ns3::CallbackBase const &', 'callback'), param('std::string', 'context')])
    ## ethernet-net-device.h (module 'ethernet'): void ns3::ProxyTracedCallback::DisconnectWithoutContext(ns3::CallbackBase const & callback) [member function]
...
def register_Ns3EthernetHelper_methods(root_module, cls):
    ## ethernet-helper.h (module 'ethernet'): ns3::EthernetHelper::EthernetHelper(ns3::EthernetHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::EthernetHelper const &', 'arg0')])
    ## ethernet-helper.h (module 'ethernet'): ns3::EthernetHelper::EthernetHelper() [constructor]
    cls.add_constructor([])
    ## ethernet-helper.h (module 'ethernet'): ns3::NetDeviceContainer ns3::EthernetHelper::Install(ns3::NodeContainer c) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::NodeContainer', 'c')])
    ## ethernet-helper.h (module 'ethernet'): ns3::NetDeviceContainer ns3::EthernetHelper::Install(ns3::Ptr<ns3::Node> a, ns3::Ptr<ns3::Node> b) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'a'), param('ns3::Ptr< ns3::Node >', 'b')])
    ## ethernet-helper.h (module 'ethernet'): ns3::NetDeviceContainer ns3::EthernetHelper::Install(ns3::Ptr<ns3::Node> a, std::string bName) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('ns3::Ptr< ns3::Node >', 'a'), param('std::string', 'bName')])
    ## ethernet-helper.h (module 'ethernet'): ns3::NetDeviceContainer ns3::EthernetHelper::Install(std::string aName, ns3::Ptr<ns3::Node> b) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'aName'), param('ns3::Ptr< ns3::Node >', 'b')])
    ## ethernet-helper.h (module 'ethernet'): ns3::NetDeviceContainer ns3::EthernetHelper::Install(std::string aNode, std::string bNode) [member function]
    cls.add_method('Install', 
                   'ns3::NetDeviceContainer', 
                   [param('std::string', 'aNode'), param('std::string', 'bNode')])
    ## ethernet-helper.h (module 'ethernet'): void ns3::EthernetHelper::SetChannelAttribute(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('SetChannelAttribute', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## ethernet-helper.h (module 'ethernet'): void ns3::EthernetHelper::SetDeviceAttribute(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('SetDeviceAttribute', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## ethernet-helper.h (module 'ethernet'): void ns3::EthernetHelper::SetQueue(std::string type, std::string n1="", ns3::AttributeValue const & v1=ns3::EmptyAttributeValue(), std::string n2="", ns3::AttributeValue const & v2=ns3::EmptyAttributeValue(), std::string n3="", ns3::AttributeValue const & v3=ns3::EmptyAttributeValue(), std::string n4="", ns3::AttributeValue const & v4=ns3::EmptyAttributeValue()) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('std::string', 'type'), param('std::string', 'n1', default_value='""'), param('ns3::AttributeValue const &', 'v1', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n2', default_value='""'), param('ns3::AttributeValue const &', 'v2', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n3', default_value='""'), param('ns3::AttributeValue const &', 'v3', default_value='ns3::EmptyAttributeValue()'), param('std::string', 'n4', default_value='""'), param('ns3::AttributeValue const &', 'v4', default_value='ns3::EmptyAttributeValue()')])
    ## ethernet-helper.h (module 'ethernet'): void ns3::EthernetHelper::EnableAsciiInternal(ns3::Ptr<ns3::OutputStreamWrapper> stream, std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool explicitFilename) [member function]
    cls.add_method('EnableAsciiInternal', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
    ## ethernet-helper.h (module 'ethernet'): void ns3::EthernetHelper::EnablePcapInternal(std::string prefix, ns3::Ptr<ns3::NetDevice> nd, bool promiscuous, bool explicitFilename) [member function]
    cls.add_method('EnablePcapInternal', 
                   'void', 
                   [param('std::string', 'prefix'), param('ns3::Ptr< ns3::NetDevice >', 'nd'), param('bool', 'promiscuous'), param('bool', 'explicitFilename')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3EthernetChannel_methods(root_module, cls):
    ## ethernet-channel.h (module 'ethernet'): ns3::EthernetChannel::EthernetChannel(ns3::EthernetChannel const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::EthernetChannel const &', 'arg0')])
    ## ethernet-channel.h (module 'ethernet'): ns3::EthernetChannel::EthernetChannel() [constructor]
    cls.add_constructor([])
    ## ethernet-channel.h (module 'ethernet'): void ns3::EthernetChannel::Attach(ns3::Ptr<ns3::EthernetNetDevice> const & dev) [member function]
    cls.add_method('Attach', 
                   'void', 
                   [param('ns3::Ptr< ns3::EthernetNetDevice > const &', 'dev')])
    ## ethernet-channel.h (module 'ethernet'): ns3::DataRate ns3::EthernetChannel::GetDataRate() const [member function]
    cls.add_method('GetDataRate', 
                   'ns3::DataRate', 
                   [], 
                   is_const=True)
    ## ethernet-channel.h (module 'ethernet'): ns3::Time ns3::EthernetChannel::GetDelay() const [member function]
    cls.add_method('GetDelay', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ethernet-channel.h (module 'ethernet'): ns3::Ptr<ns3::NetDevice> ns3::EthernetChannel::GetDevice(uint32_t i) const [member function]
    cls.add_method('GetDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True, is_virtual=True)
    ## ethernet-channel.h (module 'ethernet'): ns3::Ptr<ns3::EthernetNetDevice> ns3::EthernetChannel::GetEthernetDevice(uint32_t i) const [member function]
    cls.add_method('GetEthernetDevice', 
                   'ns3::Ptr< ns3::EthernetNetDevice >', 
                   [param('uint32_t', 'i')], 
                   is_const=True)
    ## ethernet-channel.h (module 'ethernet'): uint32_t ns3::EthernetChannel::GetNDevices() const [member function]
    cls.add_method('GetNDevices', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-channel.h (module 'ethernet'): static ns3::TypeId ns3::EthernetChannel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ethernet-channel.h (module 'ethernet'): bool ns3::EthernetChannel::SetDataRate(ns3::DataRate bps) [member function]
    cls.add_method('SetDataRate', 
                   'bool', 
                   [param('ns3::DataRate', 'bps')])
    ## ethernet-channel.h (module 'ethernet'): bool ns3::EthernetChannel::SetDelay(ns3::Time delay) [member function]
    cls.add_method('SetDelay', 
                   'bool', 
                   [param('ns3::Time', 'delay')])
    ## ethernet-channel.h (module 'ethernet'): void ns3::EthernetChannel::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3EthernetNetDevice_methods(root_module, cls):
    ## ethernet-net-device.h (module 'ethernet'): static ns3::TypeId ns3::EthernetNetDevice::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::EthernetNetDevice::EthernetNetDevice() [constructor]
    cls.add_constructor([])
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::SetMac48Address(ns3::Mac48Address address) [member function]
    cls.add_method('SetMac48Address', 
                   'bool', 
                   [param('ns3::Mac48Address', 'address')])
    ## ethernet-net-device.h (module 'ethernet'): ns3::Mac48Address ns3::EthernetNetDevice::GetMac48Address() const [member function]
    cls.add_method('GetMac48Address', 
                   'ns3::Mac48Address', 
                   [], 
                   is_const=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetInterframeGap(ns3::Time t) [member function]
    cls.add_method('SetInterframeGap', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::Attach(ns3::Ptr<ns3::EthernetChannel> const & channel) [member function]
    cls.add_method('Attach', 
                   'bool', 
                   [param('ns3::Ptr< ns3::EthernetChannel > const &', 'channel')])
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetQueue(ns3::Ptr<ns3::Queue> const & queue) [member function]
    cls.add_method('SetQueue', 
                   'void', 
                   [param('ns3::Ptr< ns3::Queue > const &', 'queue')])
    ## ethernet-net-device.h (module 'ethernet'): ns3::Ptr<ns3::Queue> ns3::EthernetNetDevice::GetQueue() const [member function]
    cls.add_method('GetQueue', 
                   'ns3::Ptr< ns3::Queue >', 
                   [], 
                   is_const=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetReceiveErrorModel(ns3::Ptr<ns3::ErrorModel> const & em) [member function]
    cls.add_method('SetReceiveErrorModel', 
                   'void', 
                   [param('ns3::Ptr< ns3::ErrorModel > const &', 'em')])
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetEncapsulationMode(ns3::CsmaNetDevice::EncapsulationMode mode) [member function]
    cls.add_method('SetEncapsulationMode', 
                   'void', 
                   [param('ns3::CsmaNetDevice::EncapsulationMode', 'mode')])
    ## ethernet-net-device.h (module 'ethernet'): ns3::CsmaNetDevice::EncapsulationMode ns3::EthernetNetDevice::GetEncapsulationMode() const [member function]
    cls.add_method('GetEncapsulationMode', 
                   'ns3::CsmaNetDevice::EncapsulationMode', 
                   [], 
                   is_const=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Ptr<ns3::CsmaNetDevice> ns3::EthernetNetDevice::GetTxDevice() const [member function]
    cls.add_method('GetTxDevice', 
                   'ns3::Ptr< ns3::CsmaNetDevice >', 
                   [], 
                   is_const=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Ptr<ns3::CsmaNetDevice> ns3::EthernetNetDevice::GetRxDevice() const [member function]
    cls.add_method('GetRxDevice', 
                   'ns3::Ptr< ns3::CsmaNetDevice >', 
                   [], 
                   is_const=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetIfIndex(uint32_t const index) [member function]
    cls.add_method('SetIfIndex', 
                   'void', 
                   [param('uint32_t const', 'index')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): uint32_t ns3::EthernetNetDevice::GetIfIndex() const [member function]
    cls.add_method('GetIfIndex', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Ptr<ns3::Channel> ns3::EthernetNetDevice::GetChannel() const [member function]
    cls.add_method('GetChannel', 
                   'ns3::Ptr< ns3::Channel >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::SetMtu(uint16_t const mtu) [member function]
    cls.add_method('SetMtu', 
                   'bool', 
                   [param('uint16_t const', 'mtu')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): uint16_t ns3::EthernetNetDevice::GetMtu() const [member function]
    cls.add_method('GetMtu', 
                   'uint16_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetAddress(ns3::Address address) [member function]
    cls.add_method('SetAddress', 
                   'void', 
                   [param('ns3::Address', 'address')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Address ns3::EthernetNetDevice::GetAddress() const [member function]
    cls.add_method('GetAddress', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::IsLinkUp() const [member function]
    cls.add_method('IsLinkUp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::AddLinkChangeCallback(ns3::Callback<void,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> callback) [member function]
    cls.add_method('AddLinkChangeCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::IsBroadcast() const [member function]
    cls.add_method('IsBroadcast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Address ns3::EthernetNetDevice::GetBroadcast() const [member function]
    cls.add_method('GetBroadcast', 
                   'ns3::Address', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::IsMulticast() const [member function]
    cls.add_method('IsMulticast', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Address ns3::EthernetNetDevice::GetMulticast(ns3::Ipv4Address multicastGroup) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv4Address', 'multicastGroup')], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Address ns3::EthernetNetDevice::GetMulticast(ns3::Ipv6Address addr) const [member function]
    cls.add_method('GetMulticast', 
                   'ns3::Address', 
                   [param('ns3::Ipv6Address', 'addr')], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetPromiscReceiveCallback(ns3::Callback<bool, ns3::Ptr<ns3::NetDevice>, ns3::Ptr<ns3::Packet const>, unsigned short, ns3::Address const&, ns3::Address const&, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    cls.add_method('SetPromiscReceiveCallback', 
                   'void', 
                   [param('ns3::Callback< bool, ns3::Ptr< ns3::NetDevice >, ns3::Ptr< ns3::Packet const >, unsigned short, ns3::Address const &, ns3::Address const &, ns3::NetDevice::PacketType, ns3::empty, ns3::empty, ns3::empty >', 'cb')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::SupportsSendFrom() const [member function]
    cls.add_method('SupportsSendFrom', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::Send(ns3::Ptr<ns3::Packet> packet, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('Send', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::SendFrom(ns3::Ptr<ns3::Packet> packet, ns3::Address const & source, ns3::Address const & dest, uint16_t protocolNumber) [member function]
    cls.add_method('SendFrom', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Address const &', 'source'), param('ns3::Address const &', 'dest'), param('uint16_t', 'protocolNumber')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): ns3::Ptr<ns3::Node> ns3::EthernetNetDevice::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::IsPointToPoint() const [member function]
    cls.add_method('IsPointToPoint', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::IsBridge() const [member function]
    cls.add_method('IsBridge', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): bool ns3::EthernetNetDevice::NeedsArp() const [member function]
    cls.add_method('NeedsArp', 
                   'bool', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ethernet-net-device.h (module 'ethernet'): void ns3::EthernetNetDevice::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
